    ...
    <div className={`App `}>
      ...
      <main className="todo-body">
            ...
            <div key={index}>
              <div className={`todo-task ${theme === "light" ? "" : "dark"}`}>
                ...
                >
                  <div>
                    <button
                      className={`todo-circle ${list.complete ? "done" : ""} `}
        ...
        <div className={`todo-bottom ${theme === "light" ? "" : "dark"}`}>
          ...
          <div>
            <button
              className={`filter-btn ${filterTodo === "all" ? "active" : ""}`}
      ...
      <footer>
        <div className={`filter-footer ${theme === "light" ? "" : "dark"}`}>
          ...
          <button
            className={`filter-btn ${filterTodo === "active" ? "active" : ""}`}
            onClick={() => setFilterTodo("active")}
          >
            Active
          </button>
